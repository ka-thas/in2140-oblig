...
gdb_create_fs_1: create_fs_1
	gdb --args ./create_fs_1 create_example1/master_file_table create_example1/block_allocation_table

gdb_create_fs_2: create_fs_2
	gdb --args ./create_fs_2 create_example2/master_file_table create_example2/block_allocation_table

gdb_create_fs_3: create_fs_3
	gdb --args ./create_fs_3 create_example3/master_file_table create_example3/block_allocation_table

gdb_load_fs: load_fs
	gdb --args ./load_fs load_example1/master_file_table load_example1/block_allocation_table

gdb_del_fs: del_fs
	gdb --args ./del_fs del_example1/master_file_table del_example1/block_allocation_table
